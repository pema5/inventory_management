...
<div class="container">
    ...
    <div class="box">
        ...
        <h1>Customer</h1>
        <p><a href="ViewCustomer.php">View Customer</a></p>
    </div>

    <div class="box">
        <img src="sales.jpg">
        <h1>Sales</h1>
        <p><a href="productsLogs.php">Sales History</a></p>
        <p><a href="productsLog.php">Predicted Sales</a></p>
